...
int				handle_elf64(t_wdy *obj)
{
    ...
    newhdr->e_shnum++;
    newhdr->e_shstrndx++;
    // copy all segments /sections data /first untouc section header
    ft_memcpy(tmp + obj->text_offset + obj->text_size + SIZE, obj->ptr + obj->text_offset + obj->text_size, hdr->e_shoff + obj->lastsc_index * sizeof(Elf64_Shdr) - (obj->text_offset + obj->text_size));
    //add new sec
    ...
    newsec->sh_addr = obj->text_addr + obj->text_size;
    newsec->sh_offset = obj->text_offset + obj->text_size;
